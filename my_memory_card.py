...
#Список вопросов
questions = list()
questions.append(Question('В какой стране ты живешь?', 'Россия', 'Англия', 'Швеция', 'США'))
questions.append(Question('Когда родился Владимир Путин?', "1952", "1986", "1991", "2012"))
questions.append(Question("Столица Португалии? ", "Лиссабон", "Москва", "Бразилиа", "Вашингтон"))
